...
def get_new_module_tests():
    new_module_tests = [
        ...
        dict(
            fullname='ConvTranspose1d_pad_valid',
            constructor=lambda: nn.ConvTranspose1d(4, 6, 3, padding="valid"),
            cpp_constructor_args='torch::nn::ConvTranspose1dOptions(4, 6, 3).padding(torch::kValid)',
            input_size=(2, 4, 7),
            cudnn=True,
            with_tf32=True,
            tf32_precision=0.005,
        ...
        dict(
            fullname='ConvTranspose1d_pad_same',
            constructor=lambda: nn.ConvTranspose1d(4, 6, 3, padding="same"),
            cpp_constructor_args='torch::nn::ConvTranspose1dOptions(4, 6, 3).padding(torch::kSame)',
            input_size=(2, 4, 7),
            cudnn=True,
            with_tf32=True,
            tf32_precision=0.005,
        ...
        dict(
            fullname='ConvTranspose1d_pad_same_dilated',
            constructor=lambda: nn.ConvTranspose1d(4, 6, 3, padding="same", dilation=2),
            cpp_constructor_args='torch::nn::ConvTranspose1dOptions(4, 6, 3).padding(torch::kSame).dilation(2)',
            input_size=(2, 4, 7),
            cudnn=True,
            with_tf32=True,
            tf32_precision=0.005,
        ...
        dict(
            fullname='ConvTranspose2d_pad_valid',
            constructor=lambda: nn.ConvTranspose2d(2, 4, (2, 3), padding="valid"),
            cpp_constructor_args='torch::nn::ConvTranspose2dOptions(2, 4, {2, 3}).padding(torch::kValid)',
            input_size=(1, 2, 4, 5),
            cudnn=True,
            with_tf32=True,
            tf32_precision=0.01,
        ...
        dict(
            fullname='ConvTranspose2d_pad_same',
            constructor=lambda: nn.ConvTranspose2d(2, 4, (2, 3), padding="same"),
            cpp_constructor_args='torch::nn::ConvTranspose2dOptions(2, 4, {2, 3}).padding(torch::kSame)',
            input_size=(1, 2, 4, 5),
            cudnn=True,
            with_tf32=True,
            tf32_precision=0.01,
        ...
        dict(
            fullname='ConvTranspose2d_pad_valid_dilated',
            constructor=lambda: nn.ConvTranspose2d(2, 4, (2, 3), padding="valid", dilation=(2, 3)),
            cpp_constructor_args='torch::nn::ConvTranspose2dOptions(2, 4, {2, 3}).padding(torch::kValid).dilation({2, 3})',
            input_size=(1, 2, 4, 5),
            cudnn=True,
            with_tf32=True,
            tf32_precision=0.005,
        ...
        dict(
            fullname='ConvTranspose2d_pad_same_dilated',
            constructor=lambda: nn.ConvTranspose2d(2, 4, (2, 3), padding="same", dilation=(2, 3)),
            cpp_constructor_args='torch::nn::ConvTranspose2dOptions(2, 4, {2, 3}).padding(torch::kSame).dilation({2, 3})',
            input_size=(1, 2, 4, 5),
            cudnn=True,
            with_tf32=True,
            tf32_precision=0.005,
        ...
        dict(
            fullname='ConvTranspose3d_pad_valid',
            constructor=lambda: nn.ConvTranspose3d(2, 4, (2, 3, 2), padding="valid"),
            cpp_constructor_args='torch::nn::ConvTranspose3dOptions(2, 4, {2, 3, 2}).padding(torch::kValid)',
            input_size=(1, 2, 4, 5, 4),
            cudnn=True,
            with_tf32=True,
            tf32_precision=0.01,
        ...
        dict(
            fullname='ConvTranspose3d_pad_same',
            constructor=lambda: nn.ConvTranspose3d(2, 4, (2, 3, 2), padding="same"),
            cpp_constructor_args='torch::nn::ConvTranspose3dOptions(2, 4, {2, 3, 2}).padding(torch::kSame)',
            input_size=(1, 2, 4, 5, 4),
            cudnn=True,
            with_tf32=True,
            tf32_precision=0.01,
        ...
        dict(
            fullname='ConvTranspose3d_pad_valid_dilated',
            constructor=lambda: nn.ConvTranspose3d(2, 4, (2, 3, 2), padding="valid", dilation=(2, 3, 2)),
            cpp_constructor_args='torch::nn::ConvTranspose3dOptions(2, 4, {2, 3, 2}).padding(torch::kValid).dilation({2, 3, 2})',
            input_size=(1, 2, 4, 5, 4),
            cudnn=True,
            with_tf32=True,
            tf32_precision=0.005,
        ...
        dict(
            fullname='ConvTranspose3d_pad_same_dilated',
            constructor=lambda: nn.ConvTranspose3d(2, 4, (2, 3, 2), padding="same", dilation=(2, 3, 2)),
            cpp_constructor_args='torch::nn::ConvTranspose3dOptions(2, 4, {2, 3, 2}).padding(torch::kSame).dilation({2, 3, 2})',
            input_size=(1, 2, 4, 5, 4),
            cudnn=True,
            with_tf32=True,
            tf32_precision=0.005,
